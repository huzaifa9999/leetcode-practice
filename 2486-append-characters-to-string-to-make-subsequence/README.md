...
<pre style="position: relative;"><strong>Input:</strong> s = "coaching", t = "coding"
...
<pre style="position: relative;"><strong>Input:</strong> s = "abcde", t = "a"
...
<pre style="position: relative;"><strong>Input:</strong> s = "z", t = "abcde"
