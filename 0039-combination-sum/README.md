...
<pre style="position: relative;"><strong>Input:</strong> candidates = [2,3,6,7], target = 7
...
<pre style="position: relative;"><strong>Input:</strong> candidates = [2,3,5], target = 8
<strong>Output:</strong> [[2,2,2,2],[2,3,3],[3,5]]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> candidates = [2], target = 1
