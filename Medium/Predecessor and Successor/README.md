...
&nbsp;   /
&nbsp;  3</span></pre>
<pre><span style="font-size: 18px;">key = 8 <strong>Output: <br></strong>6 10<strong> Explanation: <br></strong>In the given BST the inorder predecessor of 8 is 6 and inorder successor of 8 is 10.</span></pre>
